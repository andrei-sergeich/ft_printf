...
int	main(void)
{
	...
	fflush(stdout);
	printf("20) standart PRINTF : |%20.15p|\n", tab);
	ft_printf("20) my       PRINTF : |%20.15p|\n", tab);
	fflush(stdout);
	printf("21) standart PRINTF : |%-20.15p|\n", tab);
	ft_printf("21) my       PRINTF : |%-20.15p|\n", tab);
	fflush(stdout);
	printf("22) standart PRINTF : |%10p|\n", "-42");
	ft_printf("22) my       PRINTF : |%10p|\n", "-42");
	fflush(stdout);
	printf("23) standart PRINTF : |%1.p|\n", NULL);
	ft_printf("23) my       PRINTF : |%1.p|\n", NULL);
	fflush(stdout);
	printf("24) standart PRINTF : |-->|%-16.p|<-- |\n", NULL);
	ft_printf("24) my       PRINTF : |-->|%-16.p|<-- |\n", NULL);
	fflush(stdout);
	free(tab);
	free(tab2);
	ft_printf("----------------%%d-%%i--------------------\n");
	...
	printf(" - %d - symbols\n", printf("01) standart PRINTF : |%10c|", '0'));
	printf(" - %d - symbols\n", ft_printf("01) my       PRINTF : |%10c|", '0'));

	printf(" - %d - symbols\n", printf("01) standart PRINTF : |%0*.10d*0--|", 21, INT_MIN));
	printf(" - %d - symbols\n", ft_printf("01) my       PRINTF : |%0*.10d*0--|", 21, INT_MIN));
	
	printf(" - %d - symbols\n", printf("01) standart PRINTF : |%d|", INT_MIN));
	printf(" - %d - symbols\n", ft_printf("01) my       PRINTF : |%d|", INT_MIN));
